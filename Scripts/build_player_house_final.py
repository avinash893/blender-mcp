"""
BUILD REALISTIC PLAYER HOUSE — FINAL PRODUCTION RELEASE
Flawless Architecture, Unobstructed Windows, Zero Interior Clipping, PBR Shaders, Poly Haven Dressing, 19 QA Cameras, Unity Colliders, and GLB/FBX Exporter.
"""
...
def build_player_house_final():
    ...
    # ─────────────────────────────────────────────────────────────────
    # 6. INTERIOR FURNISHING: LIVING ROOM
    # ─────────────────────────────────────────────────────────────────
    ...
    make_slab("Furn_TV_Console", -3.25, -0.10, 0.24, 2.4, 0.50, 0.48, mat_cabinet, col_living)
    PH.import_model("Television_01", location=(-3.25, -0.10, 0.48), rotation=(0, 0, 180), scale=1.0)
    ...
    PH.import_model("WoodenTable_02", location=(-3.25, 2.5, 0.02), rotation=(0, 0, 90), scale=1.0)
    PH.import_model("WoodenChair_01", location=(-4.0, 2.5, 0.02), rotation=(0, 0, 90), scale=1.0)
    PH.import_model("WoodenChair_01", location=(-2.5, 2.5, 0.02), rotation=(0, 0, -90), scale=1.0)
    PH.import_model("WoodenChair_01", location=(-3.25, 1.7, 0.02), rotation=(0, 0, 0), scale=1.0)
    PH.import_model("WoodenChair_01", location=(-3.25, 3.3, 0.02), rotation=(0, 0, 180), scale=1.0)
    ...
    PH.import_model("metal_trash_can", location=(5.4, -3.8, 0.02), rotation=(0, 0, 0), scale=1.0)
    ...
    add_point_light("Light_Dining_Pendant", -3.25, 2.5, 2.35, power=35.0)
    ...
    # ─────────────────────────────────────────────────────────────────
    # 12. DEDICATED 19-CAMERA QA RIG (FINAL PERFECTED ANGLES)
    # ─────────────────────────────────────────────────────────────────
    ...
    # Interior Room Diagonal Views (8)
    ...
    create_cam("CAM_DINING", (-1.5, 1.5, 1.65), (78, 0, -135), focal_len=22.0)
    create_cam("CAM_BEDROOM", (3.0, 1.2, 1.65), (75, 0, -40), focal_len=20.0)
    create_cam("CAM_BATHROOM", (0.5, 2.0, 1.65), (76, 0, 30), focal_len=18.0)
    create_cam("CAM_STUDY", (3.0, -1.5, 1.65), (76, 0, -150), focal_len=20.0)
    ...
    return {
        ...
        "collections": [c.name for c in col_master.children],
        "message": "✓ Player House Final Production Release built and verified."
    }

if __name__ == "__main__":
    res = build_player_house_final()
    print(res)
